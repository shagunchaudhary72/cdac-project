                    ...
                    <div className="border border-1 rounded">
                        <div className="m-3">
                            <form onSubmit={addStudentDetails}>
                                ...
                                <div className="form-floating mb-3">
                                    <input type="text" className="form-control" value={states} onChange={stateTextHandler} placeholder="Enter State" />
                                    <label>State</label>
                                    <span className="text-danger">{stateError}</span>
                                </div>
                                <div className="form-floating mb-3">
                                    <input type="text" className="form-control" value={country} onChange={countryTextHandler} placeholder="Enter Country" />
                                    <label>Country</label>
                                    <span className="text-danger">{countryError}</span>
                                </div>
                                <div className="form-floating mb-3">
                                    <input type="text" className="form-control" value={pincode} onChange={pincodeTextHandler} placeholder="Enter Country" />
                                    <label>Pincode</label>
                                    <span className="text-danger">{pincodeError}</span>
                                </div>
                                <div className="form-floating mb-3">
                                    <input type="text" className="form-control" value={marks} onChange={marksTextHandler} placeholder="Enter Marks" />
